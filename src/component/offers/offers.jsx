...
const Offers = () => {
  return (
    <div className=' h-100 w-full  flex  justify-center gap-9'>
      <div className=' bg-gradient-to-bl from-inherit to-teal-300 flex p-5'>

        <div className='text-black w-[80%] flex flex-col justify-center gap-6'>
